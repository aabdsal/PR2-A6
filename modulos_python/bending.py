...
def _transicion_objeto(obj_from: str, obj_to: str, frame: robolink.Item):
    simulation.simulation_ocultar_objeto(obj_from)
    simulation.simulation_mostrar_objeto(obj_to)
    simulation.simulation_soltar_objeto(toolR, frame)
...
def _bending_generico(bend_1: str, bend_2: str, obj_0: str, obj_1: str, obj_2: str):
    ...
    _transicion_objeto(obj_0, obj_1, sistRefBend)
    ...
    _transicion_objeto(obj_1, obj_2, sistRefBend)
